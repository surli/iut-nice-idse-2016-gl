...
angular.module('unoApp')
     ...
     */
    .controller('AppController', ['$window', '$rootScope', '$scope', '$state', '$translate', '$timeout', '$q', 'Auth', 'Game', function ($window, $rootScope, $scope, $state, $translate, $timeout, $q, Auth, Game) {
